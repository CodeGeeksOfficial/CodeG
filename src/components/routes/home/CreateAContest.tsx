    ...
    <div className={props.className}>
      <div className='flex bg-white shadow-2xl rounded-lg w-fit mx-auto'>
        <div className='flex flex-col p-6'>
          <button className='md:w-3/4 text-xl md:text-3xl font-semibold px-4 py-2 border-[1px] hover:bg-[#00ffc3] hover:text-[#303136] border-[#8f9092] hover:border-transparent rounded-md transition-all duration-200'>Create a Contest</button>
