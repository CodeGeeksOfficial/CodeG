...
const MainCard = (props: Props) => {
  return (
    <div className = 'w-screen flex flex-col lg:flex-row text-white pt-6 pb-52 items-center justify-center' style={{ background: "radial-gradient(1100px 100px at bottom,#f0f0f0 99%,#141519 100%)" }}>
