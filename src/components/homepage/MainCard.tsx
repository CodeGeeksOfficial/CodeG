...
const MainCard = (props: Props) => {
  return (
    <div className='flex bg-[#303136] text-white pt-6 pb-40' style={{ background: "radial-gradient(1100px 100px at bottom,#ffffff 99%,#303136 100%)" }}>
      <div className='w-1/2 px-16 py-10 flex flex-col justify-between'>
        <div>
          <p className='text-[140px] leading-10 font-bold'>Code</p>
          <p className='text-[128px]'>Geeks</p>
          <p className='text-3xl font-light'>Code your way to success !</p>
        </div>
      ...
      <div className='flex items-center justify-center w-1/2'>
        <div className='relative border-2 rounded-full p-2'>
          ...
          <Logo className='absolute top-32 left-32' />
        </div>
      </div>
    </div>
  )
